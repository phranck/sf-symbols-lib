 ...
 * Icon: SFSliderHorizontalBelowCircleRighthalfFilled (monochrome)
 */
...
/** SFSliderHorizontalBelowCircleRighthalfFilled icon component (monochrome) */
export const SFSliderHorizontalBelowCircleRighthalfFilled = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFSliderHorizontalBelowCircleRighthalfFilled.displayName = 'SFSliderHorizontalBelowCircleRighthalfFilled';

export default SFSliderHorizontalBelowCircleRighthalfFilled;
