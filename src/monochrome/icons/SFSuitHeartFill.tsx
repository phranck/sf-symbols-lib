 ...
 * Icon: SFSuitHeartFill (monochrome)
 */
...
/** SFSuitHeartFill icon component (monochrome) */
export const SFSuitHeartFill = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFSuitHeartFill.displayName = 'SFSuitHeartFill';

export default SFSuitHeartFill;
