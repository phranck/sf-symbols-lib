 ...
 * Icon: SFCircleBottomhalfFilled (monochrome)
 */
...
/** SFCircleBottomhalfFilled icon component (monochrome) */
export const SFCircleBottomhalfFilled = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFCircleBottomhalfFilled.displayName = 'SFCircleBottomhalfFilled';

export default SFCircleBottomhalfFilled;
