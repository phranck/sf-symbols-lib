...
/** SFRectangle icon component (monochrome) */
export const SFRectangle = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFRectangle.displayName = 'SFRectangle';

export default SFRectangle;
