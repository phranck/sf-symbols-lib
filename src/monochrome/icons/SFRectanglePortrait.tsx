 ...
 * Icon: SFRectanglePortrait (monochrome)
 */
...
/** SFRectanglePortrait icon component (monochrome) */
export const SFRectanglePortrait = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFRectanglePortrait.displayName = 'SFRectanglePortrait';

export default SFRectanglePortrait;
