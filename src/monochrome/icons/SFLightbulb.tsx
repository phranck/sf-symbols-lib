...
/** SFLightbulb icon component (monochrome) */
export const SFLightbulb = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFLightbulb.displayName = 'SFLightbulb';

export default SFLightbulb;
