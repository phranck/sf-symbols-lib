 ...
 * Icon: SFExternaldriveFill (monochrome)
 */
...
/** SFExternaldriveFill icon component (monochrome) */
export const SFExternaldriveFill = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFExternaldriveFill.displayName = 'SFExternaldriveFill';

export default SFExternaldriveFill;
