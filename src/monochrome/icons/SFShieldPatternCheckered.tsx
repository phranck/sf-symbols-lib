 ...
 * Icon: SFShieldPatternCheckered (monochrome)
 */
...
/** SFShieldPatternCheckered icon component (monochrome) */
export const SFShieldPatternCheckered = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFShieldPatternCheckered.displayName = 'SFShieldPatternCheckered';

export default SFShieldPatternCheckered;
