 ...
 * Icon: SFInsetFilledToprightRectangle (monochrome)
 */
...
/** SFInsetFilledToprightRectangle icon component (monochrome) */
export const SFInsetFilledToprightRectangle = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFInsetFilledToprightRectangle.displayName = 'SFInsetFilledToprightRectangle';

export default SFInsetFilledToprightRectangle;
