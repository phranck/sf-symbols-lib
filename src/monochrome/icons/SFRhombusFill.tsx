...
/** SFRhombusFill icon component (monochrome) */
export const SFRhombusFill = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFRhombusFill.displayName = 'SFRhombusFill';

export default SFRhombusFill;
