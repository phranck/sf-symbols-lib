 ...
 * Icon: SFCircleTophalfFilled (monochrome)
 */
...
/** SFCircleTophalfFilled icon component (monochrome) */
export const SFCircleTophalfFilled = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFCircleTophalfFilled.displayName = 'SFCircleTophalfFilled';

export default SFCircleTophalfFilled;
