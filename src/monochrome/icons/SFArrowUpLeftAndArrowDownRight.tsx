 ...
 * Icon: SFArrowUpLeftAndArrowDownRight (monochrome)
 */
...
/** SFArrowUpLeftAndArrowDownRight icon component (monochrome) */
export const SFArrowUpLeftAndArrowDownRight = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFArrowUpLeftAndArrowDownRight.displayName = 'SFArrowUpLeftAndArrowDownRight';

export default SFArrowUpLeftAndArrowDownRight;
