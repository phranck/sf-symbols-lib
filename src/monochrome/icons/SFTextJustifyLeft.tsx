 ...
 * Icon: SFTextJustifyLeft (monochrome)
 */
...
/** SFTextJustifyLeft icon component (monochrome) */
export const SFTextJustifyLeft = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFTextJustifyLeft.displayName = 'SFTextJustifyLeft';

export default SFTextJustifyLeft;
