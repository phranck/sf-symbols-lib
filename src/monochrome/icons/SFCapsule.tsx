...
/** SFCapsule icon component (monochrome) */
export const SFCapsule = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFCapsule.displayName = 'SFCapsule';

export default SFCapsule;
