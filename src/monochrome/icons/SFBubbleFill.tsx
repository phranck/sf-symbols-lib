...
/** SFBubbleFill icon component (monochrome) */
export const SFBubbleFill = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFBubbleFill.displayName = 'SFBubbleFill';

export default SFBubbleFill;
