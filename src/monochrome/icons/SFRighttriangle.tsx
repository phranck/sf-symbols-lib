 ...
 * Icon: SFRighttriangle (monochrome)
 */
...
/** SFRighttriangle icon component (monochrome) */
export const SFRighttriangle = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFRighttriangle.displayName = 'SFRighttriangle';

export default SFRighttriangle;
