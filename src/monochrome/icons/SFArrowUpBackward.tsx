 ...
 * Icon: SFArrowUpBackward (monochrome)
 */
...
/** SFArrowUpBackward icon component (monochrome) */
export const SFArrowUpBackward = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFArrowUpBackward.displayName = 'SFArrowUpBackward';

export default SFArrowUpBackward;
