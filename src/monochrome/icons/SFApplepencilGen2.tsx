 ...
 * Icon: SFApplepencilGen2 (monochrome)
 */
...
/** SFApplepencilGen2 icon component (monochrome) */
export const SFApplepencilGen2 = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFApplepencilGen2.displayName = 'SFApplepencilGen2';

export default SFApplepencilGen2;
