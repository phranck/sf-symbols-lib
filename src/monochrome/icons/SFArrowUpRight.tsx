 ...
 * Icon: SFArrowUpRight (monochrome)
 */
...
/** SFArrowUpRight icon component (monochrome) */
export const SFArrowUpRight = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFArrowUpRight.displayName = 'SFArrowUpRight';

export default SFArrowUpRight;
