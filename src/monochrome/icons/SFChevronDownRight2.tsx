 ...
 * Icon: SFChevronDownRight2 (monochrome)
 */
...
/** SFChevronDownRight2 icon component (monochrome) */
export const SFChevronDownRight2 = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFChevronDownRight2.displayName = 'SFChevronDownRight2';

export default SFChevronDownRight2;
