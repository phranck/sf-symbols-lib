 ...
 * Icon: SFArrowshapeLeftFill (monochrome)
 */
...
/** SFArrowshapeLeftFill icon component (monochrome) */
export const SFArrowshapeLeftFill = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFArrowshapeLeftFill.displayName = 'SFArrowshapeLeftFill';

export default SFArrowshapeLeftFill;
