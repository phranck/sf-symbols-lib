...
/** SFRhombus icon component (monochrome) */
export const SFRhombus = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFRhombus.displayName = 'SFRhombus';

export default SFRhombus;
