 ...
 * Icon: SFChevronRight (monochrome)
 */
...
/** SFChevronRight icon component (monochrome) */
export const SFChevronRight = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFChevronRight.displayName = 'SFChevronRight';

export default SFChevronRight;
