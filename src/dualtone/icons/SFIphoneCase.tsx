...
/** SFIphoneCase icon component (dualtone) */
export const SFIphoneCase = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFIphoneCase.displayName = 'SFIphoneCase';

export default SFIphoneCase;
