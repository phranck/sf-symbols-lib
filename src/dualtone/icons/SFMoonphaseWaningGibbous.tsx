 ...
 * Icon: SFMoonphaseWaningGibbous (dualtone)
 */
...
/** SFMoonphaseWaningGibbous icon component (dualtone) */
export const SFMoonphaseWaningGibbous = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFMoonphaseWaningGibbous.displayName = 'SFMoonphaseWaningGibbous';

export default SFMoonphaseWaningGibbous;
