 ...
 * Icon: SFMoonphaseWaxingGibbous (dualtone)
 */
...
/** SFMoonphaseWaxingGibbous icon component (dualtone) */
export const SFMoonphaseWaxingGibbous = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFMoonphaseWaxingGibbous.displayName = 'SFMoonphaseWaxingGibbous';

export default SFMoonphaseWaxingGibbous;
