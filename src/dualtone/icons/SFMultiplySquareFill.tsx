 ...
 * Icon: SFMultiplySquareFill (dualtone)
 */
...
/** SFMultiplySquareFill icon component (dualtone) */
export const SFMultiplySquareFill = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFMultiplySquareFill.displayName = 'SFMultiplySquareFill';

export default SFMultiplySquareFill;
