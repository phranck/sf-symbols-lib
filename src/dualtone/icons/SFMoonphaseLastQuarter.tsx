 ...
 * Icon: SFMoonphaseLastQuarter (dualtone)
 */
...
/** SFMoonphaseLastQuarter icon component (dualtone) */
export const SFMoonphaseLastQuarter = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFMoonphaseLastQuarter.displayName = 'SFMoonphaseLastQuarter';

export default SFMoonphaseLastQuarter;
