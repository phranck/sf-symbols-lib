 ...
 * Icon: SFMoonphaseWaxingCrescent (dualtone)
 */
...
/** SFMoonphaseWaxingCrescent icon component (dualtone) */
export const SFMoonphaseWaxingCrescent = forwardRef<SVGSVGElement, SFIconProps>((props, ref) => (
  <SFIcon ref={ref} svgContent={SVG_CONTENT} viewBox={VIEW_BOX} {...props} />
));

SFMoonphaseWaxingCrescent.displayName = 'SFMoonphaseWaxingCrescent';

export default SFMoonphaseWaxingCrescent;
